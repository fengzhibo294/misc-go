...
func echo(w http.ResponseWriter, r *http.Request) {
	...
	strHost := r.Header.Get("Host")
	challengeKey := r.Header.Get("Sec-Websocket-Key")
	log.Println("strHost: ", strHost, "challengeKey:", challengeKey)
	log.Println("Head: ", r.Header)
	log.Println("r: ", r)
...
func main() {
	...
	myHandler := http.HandlerFunc(func(rw http.ResponseWriter, request *http.Request) {
		...
		log.Println("myHandler request: ", request)
